...
//		GripperPos = client.readAttribute(NID_GripperPos,attributeId).getValue().intValue();
		// GripperForce = client.readAttribute(NID_GripperPos,attributeId).getValue().intValue(); // Jason found error in this code used Position instead of Force
//		GripperForce = client.readAttribute(NID_GripperForce,attributeId).getValue().intValue(); 
...
//		}
	...
	protected static void initialize(UaClient client) throws SecureIdentityException, IOException, UnknownHostException {
		...
		appDescription.setApplicationName(new LocalizedText("Robot1_Control", Locale.ENGLISH));
		appDescription.setApplicationUri("Robot1_Control");
		appDescription.setProductUri("Robot1_Control");
